...
> A GraphQL API built with Go that serves country demographics, COVID-19 statistics, and WHO disease outbreak alerts — built as part of a country intelligence portfolio alongside the [GeoVitals Chrome Extension](https://github.com/Him97kr/chrome-extension-geovitals).
